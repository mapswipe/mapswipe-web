...
const geoJson = computed(() => createGeoJsonFromTasks(currentTasks.value))
...
<template>
  <project-header :mission="instruction" :title="props.project.projectTopic">
    ...
    <v-btn
      :title="
        numSelectedTasks === currentTasks.length
          ? $t('findProject.clearSelection')
          : $t('findProject.selectAll')
      "
